...
public class LFOSpawnChange : MonoBehaviour
{
    [SerializeField] GameObject SpawnLFO;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            //スポーンさせるオブジェクトの追加
            Instantiate(SpawnLFO, new Vector3(0, 0, 0), SpawnLFO.transform.rotation);
        }
        Debug.Log("LFOゾーンはいった");
    }
