...
public class RFOSpawnChange : MonoBehaviour
{
    [SerializeField] GameObject SpawnRFO;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            //スポーンさせるオブジェクトの追加
            Instantiate(SpawnRFO, new Vector3(0, 0, 0), SpawnRFO.transform.rotation);
        }
        Debug.Log("RFOゾーンはいった");
    }
