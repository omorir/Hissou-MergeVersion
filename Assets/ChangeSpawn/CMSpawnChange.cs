...
public class CMSpawnChange : MonoBehaviour
{
    [SerializeField] GameObject SpawnCM;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            //GameObject CM = GameObject.Find("CMSpawnPoint(Clone)");
            ...
            //スポーンさせるオブジェクトの追加
            Instantiate(SpawnCM, new Vector3(0, 0, 0), SpawnCM.transform.rotation);
        }
        Debug.Log("CMゾーンはいった");
    }
