...
public class LBOSpawnChange : MonoBehaviour
{
    [SerializeField] GameObject SpawnLBO;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            //スポーンさせるオブジェクトの追加
            Instantiate(SpawnLBO, new Vector3(0, 0, 0), SpawnLBO.transform.rotation);
        }
        Debug.Log("LBOゾーンはいった");
    }
